...
settings.fileName           = ...
   'E:\学习\正在学习的……\GPS软件接收机\数据\GPS_and_GIOVE_A-NN-fs16_3676-if4_1304.bin';
% Data type used to store one sample
settings.dataType           = 'int8';

% Intermediate, sampling and code frequencies
settings.IF                 = 4.1304e6;      %[Hz]
settings.samplingFreq       = 1.63676e7;     %[Hz]
...
% plot signal peaks if set to 1
settings.plotsignalpeaks    = 0;
